...
namespace denizdikbiyik_CET322_HW5.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Şu kullanıcı '{UserId}' kimlik uygulamalı 2FA izin verdi.", userId);

            StatusMessage = "Kimliğiniz doğrulandı.";
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("denizdikbiyik_CET322_HW5"),
